                        ...
                        {isCreator && !isSlim && (
                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity bg-white/5 p-1 rounded-lg mr-1">
                                <button
                                    ...
                                    className="p-1 px-1.5 rounded-md hover:bg-white/10 text-white/40 hover:text-white transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-orange/50"
                                >
                                    <Edit2 size={12} />
                                </button>
                                <button
                                    ...
                                    className="p-1 px-1.5 rounded-md hover:bg-red-500/20 text-white/40 hover:text-red-400 transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-red-500/50"
                                >
                                    <Trash2 size={12} />
                                </button>
                            </div>
                ...
                <div className={`${isSlim ? 'mt-1' : 'mt-2'} flex items-center justify-between`}>
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button
                            ...
                            className={`btn-ghost ${isSlim ? 'p-1.5' : 'p-2'} rounded-lg text-white/30 hover:text-white transition-all transform active:scale-95 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-orange/50`}
