                        ...
                        {isCreator && !isSlim && (
                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity bg-white/5 p-1 rounded-lg mr-1">
                                ...
                                <button
                                    ...
                                    className="p-1 px-1.5 rounded-md hover:bg-red-500/20 text-white/40 hover:text-red-400 transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-orange/50"
                                >
                                    <Trash2 size={12} />
                                </button>
                            </div>
