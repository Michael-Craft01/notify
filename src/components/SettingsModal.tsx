                    ...
                    <div className="absolute bottom-12 sm:bottom-20 left-1/2 -translate-x-1/2 w-full max-w-[440px] px-4 animate-scale-in">
                        <div className="relative w-full bg-[#0a0a0a]/90 backdrop-blur-[64px] rounded-[32px] border border-white/10 shadow-2xl overflow-hidden">
                            ...
                            <div className="px-5 py-4 flex items-center justify-between border-b border-white/5 bg-white/[0.02]">
                                ...
                                <button onClick={() => setIsOpen(false)} className="p-2 rounded-full hover:bg-white/5 text-white/20 hover:text-white transition-all" aria-label="Close Settings">
                                    <X size={18} />
                                </button>
                            </div>
                                ...
                                <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-1.5">
                                            <label htmlFor="fullName" className="text-[11px] font-bold text-white/50 ml-1 uppercase tracking-wider">Full Name</label>
